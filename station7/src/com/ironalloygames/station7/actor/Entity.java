...
public abstract class Entity extends Actor {
	...
	public float getAngle(){
		if(body != null) return body.getAngle() * 180 / MathUtils.PI;
		return 60;
	}
	
	public void setPosition(Vector2 pos){
		if(body != null) body.setTransform(pos, body.getAngle());
		this.pos.set(pos);
	}
	
	public void setPosition(Vector2 pos, float angle){
		//System.out.println("AN " + angle);
		if(body != null) body.setTransform(pos, angle);
		this.pos.set(pos);
	}
	...
	protected boolean rotationAllowed(){ return true; }
	protected float dragFactor(){ return 0; }
	protected short getCollisionGroupIndex(){ return 0; }
	protected float getRestitution(){ return 0; }

	@Override
	public void update() {
		if(body != null)
		{
			//if(this instanceof DiagnosticLockedDoor) System.out.println(this + " set pos to " + body.getPosition());
			
			pos.set(body.getPosition());
			body.setLinearVelocity(body.getLinearVelocity().mul(1 - dragFactor()));
		}
		super.update();
	}
	...
	public void moveTowards(Vector2 trg, float power)
	{
		...
		//body.setTransform(getPosition(), MathUtils.atan2(trg.y - pos.y, trg.x - pos.x));
	}
	
	public void applyForwardImpulse(float power)
	{
		body.applyForceToCenter(MathUtils.cos(body.getAngle())*power, MathUtils.sin(body.getAngle())*power);
	}
