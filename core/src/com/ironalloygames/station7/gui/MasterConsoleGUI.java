...
public class MasterConsoleGUI extends Widget {
	...
	public MasterConsoleGUI()
	{
		...
		reactivateButton.addCallback(new Runnable(){
			...
			@Override
			public void run() {
				model.setHtml("<html><body>Main Core Status: Critical<br/><br/>Operator attention needed. Power output negligible due to instability. Safety systems offline.<br/><br/>Command acknowledged. Access denied. This terminal cannot override a command from a Director. Use the manual on-site override button.</body></html>");
				Sounds.click.play();
			}
		});
